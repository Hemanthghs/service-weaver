...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/hemanthghs/service-weaver/greeter/Greeter",
		Iface: reflect.TypeOf((*Greeter)(nil)).Elem(),
		Impl:  reflect.TypeOf(greeter{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return greeter_local_stub{impl: impl.(Greeter), tracer: tracer, greetMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/hemanthghs/service-weaver/greeter/Greeter", Method: "Greet", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return greeter_client_stub{stub: stub, greetMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/hemanthghs/service-weaver/greeter/Greeter", Method: "Greet", Remote: true})}
		},
	...
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦530cd7d0:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→github.com/hemanthghs/service-weaver/greeter/Greeter⟧\n⟦3674892d:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→greet⟧\n",
	})
}
